...
-- name: InsertTodo :one
INSERT INTO todos (body, username) VALUES (?, ?) RETURNING *;
-- name: UpdateTodo :one
...
INSERT INTO chatrooms (name, creator) VALUES (?, ?) RETURNING id;
...
INSERT INTO messages (author, message, room_id, created_at) VALUES (?, ?, ?, ?);
